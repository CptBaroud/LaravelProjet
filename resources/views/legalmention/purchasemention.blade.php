...
These conditions govern the sales by the company BDE CESI Boulevard de l'Université 4600 Saint Nazaire de . 
...
On the Internet: <a href="http://www.BDE-CESI-ST-NAZAIRE.com"> www.BDE-CESI-ST-NAZAIRE.com</a>
...
Any order appearing on the website <a href="http://www.BDE-CESI-ST-NAZAIRE.com">www.BDE-CESI-ST-NAZAIRE.com</a> implies acceptance of these General Conditions. Any order confirmation implies your full and complete acceptance of these general terms and conditions of sale, without exception or reservation.  
...
Our products are offered as long as they are visible on the site <a href="http://www.BDE-CESI-ST-NAZAIRE.com">www.BDE-CESI-ST-NAZAIRE.com</a> and within the limits of available stocks. For products not in stock, our offers are valid subject to availability from our suppliers.
...
In addition, the website <a href="http://www.BDE-CESI-ST-NAZAIRE.com">www.BDE-CESI-ST-NAZAIRE.com</a> is not intended to sell its products in large quantities. Therefore the company <b>BDE CESI</b> reserves the right to refuse orders for identical items. 

<h2>Article 8 - Delivery</h2>
...
In the event of deliveries by a carrier, the company <b>BDE CESI</b> cannot be held responsible for late delivery due exclusively to the unavailability of the customer after several appointments. 

<h2>Article 9 - Warranty</h2>
...
All complaints, exchange or refund requests must be made within 30 days of delivery.  

The products must be returned to us in the condition in which you received them with all the elements (accessories, packaging, instructions, etc.). The shipping costs will be refunded to you on the basis of the invoiced rate and the return costs will be refunded to you upon presentation of supporting documents. 
...
The products offered comply with current French legislation. The company <b>BDE CESI</b> cannot be held liable in the event of non-compliance with the legislation of the country where the product is delivered. It is your responsibility to check with local authorities about the possibilities of importing or using the products or services you plan to order. 

In addition, the company <b>BDE CESI</b> cannot be held liable for any damage resulting from improper use of the purchased product. 

Finally, the company <b>BDE CESI</b> cannot be held liable for any inconvenience or damage inherent to the use of the Internet network, in particular a service interruption, an external intrusion or the presence of computer viruses. 

<h2>Article 11 - Law applicable in the event of disputes</h2>

The language of this contract is the French language. These conditions of sale are subject to French law. In the event of a dispute, the French courts shall have sole jurisdiction. 

<h2>Article 12 - Intellectual property</h2>

All elements of the site <a href="http://www.BDE-CESI-ST-NAZAIRE.com"></a>www.BDE-CESI-ST-NAZAIRE.com are and remain the intellectual and exclusive property of the company <b>BDE CESI</b>. No one is authorized to reproduce, exploit, redistribute, or use for any purpose whatsoever, even partially, elements of the site, whether software, visual or sound. Any simple or hypertext link is strictly prohibited without the express written consent of the company <b>BDE CESI</b>.  

Article 13 - Personal data

The company <b>BDE CESI</b> reserves the right to collect personal information and personal data about you. They are necessary to manage your order, as well as to improve the services and information we send you.  
...
<h2>Article 14 - Archiving Evidence</h2>

The company <b>BDE CESI</b> will archive purchase orders and invoices on a reliable and durable medium constituting a true copy in accordance with the provisions of Article 1348 of the Civil Code.  

The company's computerized records <b>BDE CESI</b> will be considered by all parties concerned as proof of communications, orders, payments and transactions between the parties.
@endsection